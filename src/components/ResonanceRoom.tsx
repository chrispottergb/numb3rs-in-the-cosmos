  ...
  return (
    <section className="relative py-24 overflow-hidden" id="resonance-room">
      ...
      <div className="relative z-10 container mx-auto px-4">
        ...
        >
          <div className="relative border-hermetic rounded-2xl bg-card/50 backdrop-blur-sm p-8 md:p-12 shadow-sacred">
            {/* Title */}
            <div className="text-center mb-10">
              <h3 className="text-2xl md:text-3xl font-display text-accent mb-4 tracking-wider">
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-10">
              {features.map((feature, index) => (
                <motion.div
                  ...
                  className="group text-center p-6 rounded-xl bg-background/50 hover:bg-primary/5 transition-all duration-300"
                >
                  <div className="w-14 h-14 mx-auto mb-4 rounded-full bg-primary/10 flex items-center justify-center group-hover:bg-primary/20 transition-colors">
                    <feature.icon className="h-7 w-7 text-primary" />
                  </div>
                  <h4 className="text-foreground font-display mb-2">{feature.title}</h4>
            ...
            >
              ...
              <p className="text-muted-foreground text-sm mt-4">
                Protected by the <span className="text-primary">3-6-9 barrier</span>
              </p>
            </motion.div>
            ...
            <div className="absolute -bottom-2 -left-2 w-8 h-8 border-l-2 border-b-2 border-accent/50 rounded-bl-lg" />
            <div className="absolute -bottom-2 -right-2 w-8 h-8 border-r-2 border-b-2 border-accent/50 rounded-br-lg" />
          </div>
        </motion.div>
      </div>
    </section>
